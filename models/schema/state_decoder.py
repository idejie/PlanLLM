...
import numpy as np
from models.schema.modules import PositionalEmbedding, transformer_layer, TransFormerDecoder
...
class StateDecoder(nn.Module):
    ...
    def process_state_query(self, state_feat, tasks,vis_proj=None):
    ...
    def forward(self, state_feat, state_prompt_features, tasks,vision_proj=None):
        ...
        state_query = self.process_state_query(state_query, tasks,vision_proj)  # [time_horz+1, batch_size, embed_dim]
        
        # print('state_query', state_query.shape)
