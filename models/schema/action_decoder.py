...
class ActionDecoder(nn.Module):
    ...
    def forward(self, state_feat, state_prompt_features, tasks,return_query=False):
        ...
        state_output = state_output[:,action_idx,:]
        if return_query:
            return action_logits, state_output, state_query
